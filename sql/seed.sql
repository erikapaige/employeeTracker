...
INSERT INTO role (title, salary, department_id) VALUES ('operations manager', 150000.00, 1);
INSERT INTO role (title, salary, department_id) VALUES ('accounting manager', 125000.00, 2);
INSERT INTO role (title, salary, department_id) VALUES ('sales manager', 125000.00, 2);
...
INSERT INTO role (title, salary, department_id) VALUES ('human resource representative', 60000.00, 5);
...
INSERT INTO employee (first_name, last_name,  role_id) VALUES ('Nicole', 'Carmine', 4);
INSERT INTO employee (first_name, last_name,  role_id) VALUES ('Tiffany', 'Burns', 3);
...
INSERT INTO employee (first_name, last_name,  role_id) VALUES ('Perri', 'Stevenson', 8);